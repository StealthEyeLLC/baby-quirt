...
gh variable set BABY_QUIRT_OAUTH_ISSUER --repo "$REPO" --body "https://baby-quirt.stealtheye.io"
gh variable set BABY_QUIRT_OAUTH_RESOURCE --repo "$REPO" --body "https://baby-quirt.stealtheye.io/mcp"
gh variable set BABY_QUIRT_OAUTH_AUDIENCE --repo "$REPO" --body "https://baby-quirt.stealtheye.io/mcp"
gh variable set BABY_QUIRT_OAUTH_JWKS_URI --repo "$REPO" --body "https://baby-quirt.stealtheye.io/oauth/jwks.json"
